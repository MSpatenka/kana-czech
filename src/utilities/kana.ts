export const kana = Object.freeze({
  hiragana: {
    ...
    regular_s: { さ: "sa", し: ["ši", "si"], す: "su", せ: "se", そ: "so" },
    regular_t: { た: "ta", ち: ["či", "ci"], つ: ["cu"], て: "te", と: "to" },
    regular_n: { な: "na", に: "ni", ぬ: "nu", ね: "ne", の: "no" },
    regular_h: { は: "ha", ひ: "hi", ふ: ["fu", "hu"], へ: "he", ほ: "ho" },
    regular_m: { ま: "ma", み: "mi", む: "mu", め: "me", も: "mo" },
    regular_y: { や: "ja", ゆ: "ju", よ: "jo" },
    regular_r: { ら: "ra", り: "ri", る: "ru", れ: "re", ろ: "ro" },
    regular_w: { わ: ["wa", "va"], を: "wo" },
    regular_nn: { ん: "n" },

    dakuten_g: { が: "ga", ぎ: "gi", ぐ: "gu", げ: "ge", ご: "go" },
    dakuten_z: { ざ: "za", じ: ["dži", "dzi"], ず: "zu", ぜ: "ze", ぞ: "zo" },
    dakuten_d: { だ: "da", ぢ: ["dži", "dzi"], づ: "zu", で: "de", ど: "do" },
    dakuten_b: { ば: "ba", び: "bi", ぶ: "bu", べ: "be", ぼ: "bo" },
    dakuten_p: { ぱ: "pa", ぴ: "pi", ぷ: "pu", ぺ: "pe", ぽ: "po" },

    combination_k: { きゃ: "kja", きゅ: "kju", きょ: "kjo" },
    combination_s: { しゃ: ["ša", "sa"], しゅ: ["šu", "su"], しょ: ["šo", "so"] },
    combination_c: { ちゃ: ["ča", "ca"], ちゅ: ["ču", "cu"], ちょ: ["čo", "co"] },
    combination_n: { にゃ: "nja", にゅ: "nju", にょ: "njo" },
    combination_h: { ひゃ: "hja", ひゅ: "hju", ひょ: "hjo" },
    combination_m: { みゃ: "mja", みゅ: "mju", みょ: "mjo" },
    combination_r: { りゃ: "rja", りゅ: "rju", りょ: "rjo" },
    combination_g: { ぎゃ: "gja", ぎゅ: "gju", ぎょ: "gjo" },
    combination_j1: { じゃ: ["dža", "dza"], じゅ: ["džu", "dzu"], じょ: ["džo", "dzo"] },
    combination_j2: { ぢゃ: ["dža", "dza"], ぢゅ: ["džu", "dzu"], ぢょ: ["džo", "dzo"] },
    combination_b: { びゃ: "bja", びゅ: "bju", びょ: "bjo" },
    combination_p: { ぴゃ: "pja", ぴゅ: "pju", ぴょ: "pjo" },
  },
  katakana: {
    regular_vowel: { ア: "a", イ: "i", ウ: "u", エ: "e", オ: "o" },
    regular_k: { カ: "ka", キ: "ki", ク: "ku", ケ: "ke", コ: "ko" },
    regular_s: { サ: "sa", シ: ["ši", "si"], ス: "su", セ: "se", ソ: "so" },
    regular_t: { タ: "ta", チ: ["či", "ci"], ツ: ["cu"], テ: "te", ト: "to" },
    regular_n: { ナ: "na", ニ: "ni", ヌ: "nu", ネ: "ne", ノ: "no" },
    regular_h: { ハ: "ha", ヒ: "hi", フ: ["fu", "hu"], ヘ: "he", ホ: "ho" },
    regular_m: { マ: "ma", ミ: "mi", ム: "mu", メ: "me", モ: "mo" },
    regular_y: { ヤ: "ja", ユ: "ju", ヨ: "jo" },
    regular_r: { ラ: "ra", リ: "ri", ル: "ru", レ: "re", ロ: "ro" },
    regular_w: { ワ: ["wa", "va"], ヲ: "wo" },
    regular_nn: { ン: "n" },

    dakuten_g: { ガ: "ga", ギ: "gi", グ: "gu", ゲ: "ge", ゴ: "go" },
    dakuten_z: { ザ: "za", ジ: ["dži", "dzi"], ズ: "zu", ゼ: "ze", ゾ: "zo" },
    dakuten_d: { ダ: "da", ヂ: ["dži", "dzi"], ヅ: "zu", デ: "de", ド: "do" },
    dakuten_b: { バ: "ba", ビ: "bi", ブ: "bu", ベ: "be", ボ: "bo" },
    dakuten_p: { パ: "pa", ピ: "pi", プ: "pu", ペ: "pe", ポ: "po" },

    combination_k: { キャ: "kja", キュ: "kju", キョ: "kjo" },
    combination_s: { シャ: ["ša", "sa"], シュ: ["šu", "su"], ショ: ["šo", "so"] },
    combination_c: { チャ: ["ča", "ca"], チュ: ["ču", "cu"], チョ: ["čo", "co"] },
    combination_n: { ニャ: "nja", ニュ: "nju", ニョ: "njo" },
    combination_h: { ヒャ: "hja", ヒュ: "hju", ヒョ: "hjo" },
    combination_m: { ミャ: "mja", ミュ: "mju", ミョ: "mjo" },
    combination_r: { リャ: "rja", リュ: "rju", リョ: "rjo" },
    combination_g: { ギャ: "gja", ギュ: "gju", ギョ: "gjo" },
    combination_j1: { ジャ: ["dža", "dza"], ジュ: ["džu", "dzu"], ジョ: ["džo", "dzo"] },
    combination_j2: { ヂャ: ["dža", "dza"], ヂュ: ["džu", "dzu"], ヂョ: ["džo", "dzo"] },
    combination_b: { ビャ: "bja", ビュ: "bju", ビョ: "bjo" },
    combination_p: { ピャ: "pja", ピュ: "pju", ピョ: "pjo" },
  },
});
